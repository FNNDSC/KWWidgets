/*=========================================================================
  ...
  Module:    $RCSfile: vtkXMLKWRenderWidgetWriter.cxx,v $
...
vtkCxxRevisionMacro(vtkXMLKWRenderWidgetWriter, "$Revision: 1.8 $");
...
int vtkXMLKWRenderWidgetWriter::AddAttributes(vtkXMLDataElement *elem)
{
  ...
  double rgb[3];
  obj->GetBackgroundColor(rgb, rgb + 1, rgb + 2);
  elem->SetVectorAttribute("BackgroundColor", 3, rgb);
